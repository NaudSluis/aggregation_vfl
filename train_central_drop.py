...
from central_deepar import CentralDataset, CentralEncoder, DeepARAutoregDrop, gaussian_nll_loss
...
def main(tune=False):
    ...
    model = DeepARAutoregDrop(args.emb_dim, args.model_hidden, pred_len=args.pred_window, sigma_eps=args.sigma_eps, dropout=0.2)
